...
from jarvis.application.standalone.workstation_impl.profiles import PROFILES
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "inventory":
        from jarvis.application.standalone.workstation_impl.inventory import format_inventory_text
    ...
    if args.command == "setup":
        from jarvis.application.standalone.workstation_impl.first_run import run_first_run_setup
