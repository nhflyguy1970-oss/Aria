...
def bootstrap_workstation(*, wait_timeout: float = DEFAULT_WAIT_SECONDS) -> dict[str, Any]:
    ...
    from jarvis.application.standalone.workstation_impl.lifecycle import up
...
def startup_greeting() -> str:
    from jarvis.application.standalone.workstation_impl.greeting import build_startup_notification
