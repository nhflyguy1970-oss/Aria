...
(function () {
  ...
  function registerSystem() {
    reg([
      ...
      mk("act:models-editor", "Open models editor", "System", "ollama providers", () => A().system.modelsEditor()),
      mk("act:pull-models", "Pull missing models", "System", "download ollama", () => A().system.pullModels()),
