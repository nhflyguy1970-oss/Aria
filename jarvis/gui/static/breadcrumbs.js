...
(function () {
  ...
  const MAP = {
    ...
    planner: { section: "Workspace", sectionKey: "workspaces", label: "Planner" },
    calendar: { section: "Workspace", sectionKey: "workspaces", label: "Calendar" },
    journal: { section: "Workspace", sectionKey: "workspaces", label: "Bullet Journal" },
    memory: { section: "Workspace", sectionKey: "workspaces", label: "Memory" },
    documents: { section: "Workspace", sectionKey: "workspaces", label: "Documents" },
