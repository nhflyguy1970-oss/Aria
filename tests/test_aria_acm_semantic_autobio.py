...
def test_sem_01_version_pin() -> None:
    ...
    assert data["source_commit"] == "a4c962ea30c76e78a7bf73fb66d04f6ed27f13f2"
    assert data["aria_acm_local_version"] == "aria-acm-v0.26.0-5"
    assert data["promotion"] == "M3-ACM-evolution"
