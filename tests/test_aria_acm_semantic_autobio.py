...
def test_sem_01_version_pin() -> None:
    ...
    assert data["source_commit"] == "931f40c386e7d828641fe50cc4545dfe207fe300"
    assert data["aria_acm_local_version"] == "aria-acm-v0.26.0-4"
    assert data["promotion"] == "M3-ACM-semantic"
