"""Aria promotion gates — Cap5 temporal patterns retained under ACM v0.37.0 pin."""
...
def test_m5_cap5_pin_and_temporal_module() -> None:
    ...
    assert data["source_version"] == "0.37.0"
    assert data["aria_acm_local_version"] == "aria-acm-v0.37.0-1"
