...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "b720cbb32d36f61af5287adef1aac0a4d5d5b7f2"
    assert meta["source_tag"] == "v0.45.1"
    assert meta["source_version"] == "0.45.1"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.45.1-1"
