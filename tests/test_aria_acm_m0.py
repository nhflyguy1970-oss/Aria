...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "1850ad7dc85b3ba948eb0e8b77bf33b3fdb6eae9"
    assert meta["source_tag"] == "v0.27.0"
    assert meta["source_version"] == "0.27.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.27.0-1"
