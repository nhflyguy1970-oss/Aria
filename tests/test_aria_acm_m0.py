...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "e6a71fb9d947a0b34402ec835e6a1e0665c8f9f8"
    assert meta["source_tag"] == "v0.45.0"
    assert meta["source_version"] == "0.45.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.45.0-1"
