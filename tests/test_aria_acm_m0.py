...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "6185854e2adf56aabc13d26f6a51d9fce660a01a"
    assert meta["source_tag"] == "v0.33.0"
    assert meta["source_version"] == "0.33.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.33.0-1"
