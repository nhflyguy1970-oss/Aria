...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "454dcb90a352a3f1daa44aa95ff7b2801994f4e3"
    assert meta["source_tag"] == "v0.14.0"
    assert meta["source_version"] == "0.14.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.14.0-1"
