...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "166054df9ffbd2eec34c1da559cc76c9da0f3c3e"
    assert meta["source_tag"] == "v0.34.0"
    assert meta["source_version"] == "0.34.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.34.0-1"
