...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "5c90f634e930d622e986f004486fbdfcd3814dd9"
    assert meta["source_tag"] == "v0.40.0"
    assert meta["source_version"] == "0.40.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.40.0-1"
