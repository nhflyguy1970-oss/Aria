...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "32446e88913c26645819d04d3e7785ea6ddf438c"
    assert meta["source_tag"] == "v0.35.0"
    assert meta["source_version"] == "0.35.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.35.0-1"
