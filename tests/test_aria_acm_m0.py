...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "2ce664b1d7faa78a435ea399859760e9e3d9ddce"
    assert meta["source_tag"] == "v0.32.0"
    assert meta["source_version"] == "0.32.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.32.0-1"
