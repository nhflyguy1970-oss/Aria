...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "af108d0893c7aee11f21f96fba51e8641f219ae2"
    assert meta["source_tag"] == "v0.17.0"
    assert meta["source_version"] == "0.17.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.17.0-1"
