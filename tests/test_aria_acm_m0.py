...
def test_m0_01_version_json_pin_matches_tree_hash() -> None:
    ...
    assert meta["source_commit"] == "d71a6af77dab578fd85ace14e241a72df3ce59a1"
    assert meta["source_tag"] == "v0.25.0"
    assert meta["source_version"] == "0.25.0"
    assert meta["aria_acm_local_version"] == "aria-acm-v0.25.0-1"
