...
def test_evo_01_version_pin() -> None:
    ...
    assert data["source_commit"] == "2ce664b1d7faa78a435ea399859760e9e3d9ddce"
    assert data["aria_acm_local_version"] == "aria-acm-v0.32.0-1"
    assert data["promotion"] == "M5-ACM-CAP5-TEMPORAL"
