...
def test_command_palette_is_wired():
    ...
    assert "Connection restored" in Path("jarvis/gui/static/app.js").read_text(encoding="utf-8")
    assert "Forked branch:" in Path("jarvis/gui/static/app.js").read_text(encoding="utf-8")
